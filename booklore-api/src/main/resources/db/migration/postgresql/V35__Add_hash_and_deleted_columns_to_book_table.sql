...
CREATE INDEX IF NOT EXISTS idx_book_initial_hash ON book(LEFT(initial_hash, 255));
CREATE INDEX IF NOT EXISTS idx_book_current_hash ON book(LEFT(current_hash, 255));
