...
public class BookParserConfig {
    ...
    public Map<MetadataProvider, BookParser> parserMap(GoogleParser googleParser, AmazonBookParser amazonBookParser,
                                                       GoodReadsParser goodReadsParser, HardcoverParser hardcoverParser, ComicvineBookParser comicvineBookParser, DoubanBookParser doubanBookParser, LubimyCzytacParser lubimyczytacParser, KoboParser koboParser) {
        return Map.of(
                ...
                MetadataProvider.Kobo, koboParser
        );
    }
}
