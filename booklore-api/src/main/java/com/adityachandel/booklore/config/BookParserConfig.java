...
public class BookParserConfig {
    ...
    public Map<MetadataProvider, BookParser> parserMap(GoogleParser googleParser, AmazonBookParser amazonBookParser,
                                                       GoodReadsParser goodReadsParser, HardcoverParser hardcoverParser, ComicvineBookParser comicvineBookParser, DoubanBookParser doubanBookParser, RanobeDbParser ranobedbParser, LubimyCzytacParser lubimyczytacParser, LocalFileParser localFileParser) {
        return Map.of(
                ...
                MetadataProvider.LocalFile, localFileParser
        );
    }
}
