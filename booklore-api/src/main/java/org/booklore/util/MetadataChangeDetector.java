...
public class MetadataChangeDetector {
    ...
    private static final List<FieldDescriptor<?>> SIMPLE_FIELDS = List.of(
            ...
            new FieldDescriptor<String>("subtitle",
                    ...
                    f -> Boolean.TRUE.equals(f.getSubtitle()), true),
            new FieldDescriptor<String>("publisher",
                    ...
                    f -> Boolean.TRUE.equals(f.getPublisher()), true),
            new FieldDescriptor<java.time.LocalDate>("publishedDate",
                    ...
                    f -> Boolean.TRUE.equals(f.getPublishedDate()), true),
            new FieldDescriptor<String>("description",
                    ...
                    f -> Boolean.TRUE.equals(f.getDescription()), true),
            new FieldDescriptor<String>("seriesName",
                    ...
                    f -> Boolean.TRUE.equals(f.getSeriesName()), true),
            new FieldDescriptor<Float>("seriesNumber",
                    ...
                    f -> Boolean.TRUE.equals(f.getSeriesNumber()), true),
            new FieldDescriptor<Integer>("seriesTotal",
            ...
            new FieldDescriptor<String>("goodreadsId",
                    ...
                    f -> Boolean.TRUE.equals(f.getGoodreadsId()), true),
            new FieldDescriptor<String>("comicvineId",
                    ...
                    f -> Boolean.TRUE.equals(f.getComicvineId()), true),
            new FieldDescriptor<String>("hardcoverId",
                    ...
                    f -> Boolean.TRUE.equals(f.getHardcoverId()), true),
            new FieldDescriptor<String>("hardcoverBookId",
                    ...
                    f -> Boolean.TRUE.equals(f.getHardcoverBookId()), true),
            new FieldDescriptor<String>("googleId",
                    ...
                    f -> Boolean.TRUE.equals(f.getGoogleId()), true),
            new FieldDescriptor<String>("lubimyczytacId",
                    ...
                    f -> Boolean.TRUE.equals(f.getLubimyczytacId()), true),
            new FieldDescriptor<String>("ranobedbId",
                    ...
                    f -> Boolean.TRUE.equals(f.getRanobedbId()), true),
            new FieldDescriptor<String>("language",
                    ...
                    f -> Boolean.TRUE.equals(f.getLanguage()), true),
            new FieldDescriptor<Integer>("pageCount",
                    ...
                    f -> Boolean.TRUE.equals(f.getPageCount()), false),
            new FieldDescriptor<Double>("amazonRating",
                    ...
                    f -> Boolean.TRUE.equals(f.getAmazonRating()), false),
            new FieldDescriptor<Integer>("amazonReviewCount",
                    ...
                    f -> Boolean.TRUE.equals(f.getAmazonReviewCount()), false),
            new FieldDescriptor<Double>("goodreadsRating",
                    ...
                    f -> Boolean.TRUE.equals(f.getGoodreadsRating()), false),
            new FieldDescriptor<Integer>("goodreadsReviewCount",
                    ...
                    f -> Boolean.TRUE.equals(f.getGoodreadsReviewCount()), false),
            new FieldDescriptor<Double>("hardcoverRating",
                    ...
                    f -> Boolean.TRUE.equals(f.getHardcoverRating()), false),
            new FieldDescriptor<Integer>("hardcoverReviewCount",
                    ...
                    f -> Boolean.TRUE.equals(f.getHardcoverReviewCount()), false),
            new FieldDescriptor<Double>("lubimyczytacRating",
                    ...
                    f -> Boolean.TRUE.equals(f.getLubimyczytacRating()), false),
            new FieldDescriptor<Double>("ranobedbRating",
                    ...
                    f -> Boolean.TRUE.equals(f.getRanobedbRating()), false),
            new FieldDescriptor<String>("narrator",
                    ...
                    f -> Boolean.TRUE.equals(f.getNarrator()), false),
            new FieldDescriptor<Boolean>("abridged",
                    ...
                    f -> Boolean.TRUE.equals(f.getAbridged()), false),
            new FieldDescriptor<Integer>("ageRating",
                    ...
                    f -> Boolean.TRUE.equals(f.getAgeRating()), false),
            new FieldDescriptor<String>("contentRating",
                    ...
                    f -> Boolean.TRUE.equals(f.getContentRating()), false)
    );
    ...
    private static final List<CollectionFieldDescriptor> COLLECTION_FIELDS = List.of(
            new CollectionFieldDescriptor("authors",
                    ...
                    f -> Boolean.TRUE.equals(f.getAuthors()), true),
            new CollectionFieldDescriptor("categories",
                    ...
                    f -> Boolean.TRUE.equals(f.getCategories()), true),
            new CollectionFieldDescriptor("moods",
                    ...
                    f -> Boolean.TRUE.equals(f.getMoods()), false),
            new CollectionFieldDescriptor("tags",
                    ...
                    f -> Boolean.TRUE.equals(f.getTags()), false)
    );
