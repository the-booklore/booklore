...
class EntityEqualityTest {
    ...
    void authorEntity_shouldBeEqual_whenNamesAreSame() {
        // 1. Same Name, Different IDs -> Should be EQUAL
        ...
        assertEquals(a1, a2, "Entities with same name should be equal");
    ...
    void authorEntity_shouldNotBeEqual_whenNamesAreDifferent() {
        // 2. Different Name, Same ID -> Should be DIFFERENT
        AuthorEntity a1 = AuthorEntity.builder().id(1L).name("Author A").build();
    ...
    @Test
    void set_shouldDeduplicate_basedOnName() {
        ...
        AuthorEntity a2 = AuthorEntity.builder().id(200L).name("John").build(); // Same name
        AuthorEntity a3 = AuthorEntity.builder().id(300L).name("Jane").build();
    ...
    @Test
    void unsavedEntities_withSameNames_shouldBeEqual() {
        AuthorEntity a1 = AuthorEntity.builder().name("John").build();
        AuthorEntity a2 = AuthorEntity.builder().name("John").build();

        assertEquals(a1, a2, "Unsaved entities with same names should be equal");
    }
