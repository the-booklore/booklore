...
export class MetadataEditorComponent implements OnInit {
  ...
  private buildMetadataWrapper(
    ...
    const metadata: BookMetadata = {
      ...
      ranobedbReviewCount: form.get("ranobedbReviewCount")?.value,
...
<<<<<<< HEAD
      ...
      ranobedbReviewCountLocked: form.get("ranobedbReviewCountLocked")?.value,
    ...
    const clearFlags: MetadataClearFlags = {
      ...
      ranobedbReviewCount: wasCleared("ranobedbReviewCount"),
