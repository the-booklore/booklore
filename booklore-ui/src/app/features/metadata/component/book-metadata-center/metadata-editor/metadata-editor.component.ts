...
export class MetadataEditorComponent implements OnInit {
  ...
  constructor() {
    this.metadataForm = new FormGroup({
      ...
      seriesVolumeLocked: new FormControl(false),
  ...
  private populateFormFromMetadata(metadata: BookMetadata): void {
    this.metadataForm.patchValue({
      ...
      seriesVolume: metadata.seriesVolume ?? null,
      ...
      seriesVolumeLocked: metadata.seriesVolumeLocked ?? false,
    ...
    const lockableFields: { key: keyof BookMetadata; control: string }[] = [
      ...
      {key: "seriesVolumeLocked", control: "seriesVolume"},
  ...
  private buildMetadataWrapper(shouldLockAllFields?: boolean): MetadataUpdateWrapper {
    ...
    const metadata: BookMetadata = {
      ...
      seriesVolume: form.get("seriesVolume")?.value,
      ...
      seriesVolumeLocked: form.get("seriesVolumeLocked")?.value,
    ...
    const clearFlags: MetadataClearFlags = {
      ...
      seriesVolume: wasCleared("seriesVolume"),
