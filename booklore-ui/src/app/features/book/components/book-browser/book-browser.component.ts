...
export class BookBrowserComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  applySortOption(sortOption: SortOption): void {
    ...
    // Map UI fields to Backend fields if they differ
    ...
    // ReadStatus is complex. BookEntity doesn't have readStatus. It's computed from UserBookProgress?
    // If readStatus sort is broken, it's hard to fix without backend change.
    // But user didn't explicitly naming readStatus.
    // I will map seriesNumber which was named.
